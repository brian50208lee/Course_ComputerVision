...
public class BinaryMorphology {
	...
	public static BufferedImage hitAndMiss(BufferedImage bi, String kernelShape1, String kernelShape2){
		BufferedImage source = ImgUtil.imgBinarize(bi, 128);
		BufferedImage source_c = new BufferedImage(source.getWidth(), source.getHeight(), source.getType());
		BufferedImage result1 = new BufferedImage(bi.getWidth(), bi.getHeight(), bi.getType());
		BufferedImage result2 = new BufferedImage(bi.getWidth(), bi.getHeight(), bi.getType());
		BufferedImage finalResult = new BufferedImage(bi.getWidth(), bi.getHeight(), bi.getType());
